    ...
    <div>
      <Mobile>
        <Box
          ...
          position="relative"
        >
          <Box flexGrow={1} sx={{ backgroundColor: "#ffffff" }}>
            <Grid
              container
              alignItems="center"
            ...
            <Grid
              ...
              container
              spacing={2}
              sx={{ marginLeft: "3px", marginRight: "auto", width: "95%" }}
            >
              <Grid item xs={6}>
                <Card onClick={navigateToPage2}>
                  <CardMedia
                    ...
                    alt="Image 1"
                  />
                  <CardContent sx={{ backgroundColor: "#ffffff", textAlign: "left" }}>
                    <Typography
                      variant="caption"
                      component="div"
              ...
              <Grid item xs={12}>
                <Card>
                  <CardMedia
                    component="img"
                    height="140"
                    image="../assets/images/Banner9.jpg"
                    alt="Image 1"
                  />
              ...
              <Grid item xs={12}>
                <Card>
                  <CardMedia
                    component="img"
                    height="140"
                    image="../assets/images/Banner10.jpg"
                    alt="Image 2"
                  />
                  <CardContent sx={{ backgroundColor: "#ffffff" }}>
                    <Typography
